    ...
    <div className="pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-20">
          ...
          >
            A curated selection of digital experiences we've crafted for forward-thinking brands.
          </motion.p>
        </header>
            ...
            >
              ...
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <p className="text-sm text-black/40 uppercase tracking-widest font-medium">{project.category}</p>
                </div>
        ...
        >
          <h2 className="text-3xl font-bold tracking-tighter mb-6 uppercase">And many more...</h2>
          <p className="text-black/60 mb-10 max-w-lg mx-auto">
            We have a vast portfolio of specialized solutions. Contact us to see more relevant examples for your industry.
          </p>
