...
const LOCATIONS = [
  { id: 'london', city: "London", country: "UK", coords: { lat: 51.5074, lng: -0.1278 }, roleKey: "about.locations.headquarters" },
  { id: 'amsterdam', city: "Amsterdam", country: "NL", coords: { lat: 52.3676, lng: 4.9041 }, roleKey: "about.locations.spaceSoftware" },
  { id: 'istanbul', city: "Istanbul", country: "TR", coords: { lat: 41.0082, lng: 28.9784 }, roleKey: "about.locations.rdCenter" },
  { id: 'newyork', city: "New York", country: "USA", coords: { lat: 40.7128, lng: -74.0060 }, roleKey: "about.locations.operations" }
];
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden px-6">
        <motion.div style={{ opacity, scale }} className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="italic font-light opacity-20">{t('about.heroTitle2')}</span>
          </motion.h1>
            ...
            <div className="lg:col-span-8 relative">
              <div className="relative aspect-[16/9] w-full bg-[#050505] rounded-3xl border border-white/5 overflow-hidden group shadow-[0_0_100px_rgba(0,0,0,1)]">
                ...
                <div className="absolute bottom-8 left-8 flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-white/40">{t('about.realtimeSync')}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-40 bg-white text-black px-6 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-black/40 mb-12 block">{t('about.philosophyLabel')}</span>
            <h2 className="text-6xl md:text-8xl font-bold tracking-tighter uppercase leading-[0.85] mb-16">
              {t('about.invisibleTitle1')} <br />
              <span className="italic font-light opacity-20">{t('about.invisibleTitle2')}</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              { title: t('about.precision'), desc: t('about.precisionDesc'), icon: Shield },
              { title: t('about.discretion'), desc: t('about.discretionDesc'), icon: Zap },
              { title: t('about.legacy'), desc: t('about.legacyDesc'), icon: Globe }
            ].map((item, i) => (
      ...
      <section className="py-40 px-6 bg-neutral-50 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-bold tracking-tighter uppercase mb-12">
            {t('about.ctaTitle1')} <br />
            <span className="italic font-light opacity-40">{t('about.ctaTitle2')}</span>
          </h2>
