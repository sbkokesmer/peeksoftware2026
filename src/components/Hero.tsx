      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <span className="inline-block py-1 px-3 border border-foreground/20 text-[10px] tracking-[0.3em] uppercase mb-8">
            Digital Excellence • Global Impact
          </span>
          <h1 className="text-6xl md:text-8xl font-bold tracking-tighter leading-[0.9] mb-8 text-balance">
            WE ARCHITECT THE <br />
            <span className="italic font-light">AVANT-GARDE</span> OF DIGITAL.
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-md mb-10 leading-relaxed">
            Peek is a high-end digital collective. We partner with ambitious brands to engineer sophisticated ecosystems that redefine industry standards.
          </p>
        ...
        >
          ...
          <div className="absolute bottom-8 left-8 bg-background p-6 hidden md:block">
            <p className="text-[10px] tracking-[0.2em] uppercase opacity-50 mb-2">Current Focus</p>
            <p className="text-sm font-bold tracking-tight">AI-Driven Commerce &<br />Immersive Web Experiences</p>
          </div>
        </motion.div>
      </div>
